...
export default {
  ...
  rapid: {
    ...
    No: 'Нет быстрого тестирования',
  },
  pcr: {
    category: 'ПЦР-тестирование',
    yes: 'Предлагает тестирование ПЦР (подробности по телефону)',
    Yes: 'Предлагает тестирование ПЦР (подробности по телефону)',
  ...
  tooltips: {
    symptomatic: 'Чтобы узнать подробную информацию, см. симптомы коронавирусной инфекции (CDC)',
  },
};
