    ...
    data: {
      ...
      messages: {
        'en-US': {
          ...
          restrictions: {
            m18: 'Must be 18 years or older.',
            m14: 'Must be 14 years or older.',
            npo: 'Network patients only.',
            lip: 'Low-income patients.',
            pmed: 'Priority given to health care workers and first responders.',
            up: 'Unsheltered population.'
          },
          notes:{
            ca: 'Call ahead for an appointment.',
            c10jeff: 'Call 10 minutes before arrival. Schedule appointment through JeffConnect and JeffNow.',
            arjeff: 'Appointments/referrals through JeffConnect.',
            carmercy: 'Call ahead for an appointment. Referrals from Mercy physician required.',
            rmercy: 'Referral from Mercy physician required.',
            r: 'Referral by provider required.',
            trs: 'Testing regardless of symptoms.',
            wa: 'Walk-ins allowed, no appointment necessary.',
          },
          facilityType: {
            cl: 'Clinic',
            uc: 'Urgent Care',
            ho: 'Hospital',
            hc: 'Health Center',
            hcc: 'Health Center (City)',
            ds: 'Drug Store',
            hcphmc: 'Health center (PHMC)',
            fs: 'Field Site',
            me: 'Medical',
            ot: 'Other',
          },
        ...
        'es': {
          ...
          restrictions: {
            m18: 'Spanish Must be 18 years or older.',
            m14: 'Spanish Must be 14 years or older.',
            npo: 'Spanish Network patients only.',
            lip: 'Spanish Low-income patients.',
            pmed: 'Spanish Priority given to health care workers and first responders.',
            up: 'Spanish Unsheltered population.'
          },
          notes:{
            ca: 'Spanish Call ahead for an appointment.',
            ca10jeff: 'Spanish Call 10 minutes before arrival. Schedule appointment through JeffConnect and JeffNow.',
            arjeff: 'Spanish Appointments/referrals through JeffConnect.',
            carmercy: 'Spanish Call ahead for an appointment. Referrals from Mercy physician required.',
            rmercy: 'Spanish Referral from Mercy physician required.',
            r: 'Spanish Referral by provider required.',
            trs: 'Spanish Testing regardless of symptoms.',
            wa: 'Spanish Walk-ins allowed, no appointment necessary.',
          },
          facilityType: {
            cl: 'Spanish Clinic',
            uc: 'Spanish Urgent Care',
            ho: 'Spanish Hospital',
            hc: 'Spanish Health Center',
            hcc: 'Spanish Health Center (City)',
            ds: 'Spanish Drug Store',
            hcphmc: 'Spanish Health center (PHMC)',
            fs: 'Spanish Field Site',
            me: 'Spanish Medical',
            ot: 'Spanish Other',
          },
