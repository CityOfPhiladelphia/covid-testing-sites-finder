    ...
    data: {
      ...
      messages: {
        ...
        'es': {
          ...
          process: 'Spanish Process',
          referralRequired: 'Spanish Referral needed?',
          eligibility: 'Elegibilidad',
          testingHours: 'Spanish Testing hours',
          daysOfOperation: 'Spanish Days of operation',
          Monday: 'Lunes',
          Tuesday: 'Martes',
          Wednesday: 'Miércoles',
          Thursday: 'Jueves',
          ...
          driveThrough: {
            dt: 'Spanish Drive-thru',
            wu: 'Spanish Walk-up',
            both: 'Spanish Drive-thru & walk-up',
          },
          panelText:{
            p1: 'Spanish If you are unable to get a COVID-19 test through your health care provider, this tool can help you find a free test within the City of Philadelphia.',
          },
          restrictions: {
            lowInc: 'Spanish Intended for low-income families and individuals.',
            year14: 'Spanish Must be 14 years or older.',
          ...
          notes:{
            ...
            refReq: 'Spanish Referral required',
            schedAppRefReq: 'Spanish Must schedule an appointment. Referral required.',
            noApp: 'Spanish No appointment necessary.',
            testAll: 'Spanish Testing provided even if symptoms are not present',
          },
          facilityType: {
            drugstore: 'Spanish Drugstore',
            fieldSite: 'Spanish Field Site',
            clinic: 'Spanish Clinic',
            hospital: 'Spanish Hospital',
            other: 'Spanish Other',
            phmcHC: 'Spanish PHMC health center',
            urgentCare: 'Spanish Urgent Care',
            cityHC: 'Spanish City health center',
            homelessServices: 'Spanish Homeless services',
          },
