      ...
      messages: {
        'en-US': {
          ...
          facilityType: {
            ...
            'Health Center (City)' : 'Health Center (City)',
        ...
        'es': {
          ...
          driveThrough: {
            'Drive-thru': 'Spanish Drive thru',
            'Walk-up': 'Spanish Walk up',
            'Drive-thru/walk-up': 'Spanish Drive-thru/walk-up',
          },
          panelText:{
          ...
          restrictons: {
            'Must be 18 years or older': 'Spanish Must be 18 years or older',
            'Must be 14 years or older': 'Spanish Must be 14 years or older',
            'Network patients only': 'Spanish Network patients only',
            'Low-income patients': 'Spanish Low-income patients',
            'Priority given to health care workers and first responders': 'Spanish Priority given to health care workers and first responders',
          },
          notes:{
            'Call ahead for an appointment.': 'Spanish Call ahead for an appointment.',
            'Call 10 minutes before arrival. Schedule appointment through JeffConnect and JeffNow.' : 'Spanish Call 10 minutes before arrival. Schedule appointment through JeffConnect and JeffNow.',
            'Closed Call ahead for an appointment. Referrals from Mercy physician required.': 'Spanish Closed Call ahead for an appointment. Referrals from Mercy physician required.',
            'Appointments/referrals through JeffConnect.' : 'Spanish Appointments/referrals through JeffConnect.',
            'Closed Appointments/referral through JeffConnect': 'Spanish Closed Appointments/referral through JeffConnect',
            'Referral from Mercy physician required.': 'Spanish Referral from Mercy physician required.',
            'Referral by provider required.': 'Spanish Referral by provider required.',
            'Walk-ins allowed, no appointment necessary.' : 'Spanish Walk-ins allowed, no appointment necessary.',
            'Call 10 minutes before arrival. Schedule appointment through /JeffConnect and JeffNow.' : 'Spanish Call 10 minutes before arrival. Schedule appointment through JeffConnect and JeffNow.',
          },
          facilityType: {
            'Clinic': 'Spanish Clinic',
            'Urgent Care' : 'Spanish Urgent Care',
            'Hospital' : 'Spanish Hospital',
            'Health Center' : 'Spanish Health Center',
            'Health Center (City)' : 'Spanish Health Center (City)',
            'Drugstore': 'Spanish Drug Store',
            'Health center (PHMC)': 'Spanish Health center (PHMC)',
            'Field site': 'Spanish Field Site',
